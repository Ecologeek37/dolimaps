...
/**
 * \file    test/phpunit/DoliMapsFunctionalTest.php
 * \ingroup dolimaps
 ...
 *
 * @package Testdolimaps
 */
class DoliMapsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolimaps/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolimaps/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolimaps/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolimaps/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolimapswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliMaps_DoliMapsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliMaps_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
